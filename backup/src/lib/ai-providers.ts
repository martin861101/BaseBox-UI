...
export const PROVIDERS: ProviderDef[] = [
  {
    ...
    authType: "apiKey",
    models: [
      { id: "gpt-5.5", label: "GPT-5.5", contextWindow: 1048576, supportsTools: true, supportsVision: true },
      { id: "o5-mini", label: "o5-mini", contextWindow: 200000, supportsTools: true, supportsVision: true },
      { id: "o4", label: "o4", contextWindow: 200000, supportsTools: true, supportsVision: true },
      { id: "o3-mini", label: "o3-mini", contextWindow: 200000, supportsTools: true, supportsVision: true },
    ],
  },
  {
    id: "gemini",
    ...
    authType: "apiKey",
    models: [
      { id: "gemini-3.1-pro-preview", label: "Gemini 3.1 Pro", contextWindow: 2097152, supportsTools: true, supportsVision: true },
      { id: "gemini-3-flash-preview", label: "Gemini 3 Flash", contextWindow: 1048576, supportsTools: true, supportsVision: true },
      { id: "gemini-3.1-flash-lite", label: "Gemini 3.1 Flash Lite", contextWindow: 1048576, supportsTools: true, supportsVision: true },
      { id: "gemini-3.1-flash-live", label: "Gemini 3.1 Live", contextWindow: 1048576, supportsTools: true, supportsVision: true },
    ],
  },
  {
    id: "claude",
    ...
    authType: "apiKey",
    models: [
      { id: "claude-opus-4-7", label: "Claude Opus 4.7", contextWindow: 200000, supportsTools: true, supportsVision: true },
      { id: "claude-sonnet-4-6", label: "Claude Sonnet 4.6", contextWindow: 1000000, supportsTools: true, supportsVision: true },
      { id: "claude-haiku-4-0", label: "Claude Haiku 4.0", contextWindow: 200000, supportsTools: true, supportsVision: false },
    ],
  },
  {
    id: "ollama",
    ...
    authType: "none",
    models: [
      { id: "llama3.3", label: "Llama 3.3 70B", contextWindow: 131072, supportsTools: true, supportsVision: false, local: true },
      { id: "llama3.2", label: "Llama 3.2 3B", contextWindow: 131072, supportsTools: true, supportsVision: false, local: true },
      { id: "mistral", label: "Mistral 7B", contextWindow: 32768, supportsTools: false, supportsVision: false, local: true },
      { id: "phi4", label: "Phi-4 14B", contextWindow: 16384, supportsTools: false, supportsVision: false, local: true },
      { id: "qwen2.5-coder", label: "Qwen 2.5 Coder", contextWindow: 131072, supportsTools: true, supportsVision: false, local: true },
      { id: "deepseek-r1", label: "DeepSeek R1", contextWindow: 131072, supportsTools: false, supportsVision: false, local: true },
      { id: "gemma2", label: "Gemma 2 9B", contextWindow: 8192, supportsTools: false, supportsVision: false, local: true },
      { id: "codellama", label: "CodeLlama 7B", contextWindow: 16384, supportsTools: false, supportsVision: false, local: true },
    ],
  },
  {
    id: "openrouter",
    ...
    authType: "apiKey",
    models: [
      { id: "openai/gpt-5.5-thinking", label: "GPT-5.5 Thinking (via OR)", contextWindow: 1000000, supportsTools: true, supportsVision: true },
      { id: "anthropic/claude-4.7-opus", label: "Claude Opus 4.7 (via OR)", contextWindow: 200000, supportsTools: true, supportsVision: true },
      { id: "google/gemini-3.1-pro", label: "Gemini 3.1 Pro (via OR)", contextWindow: 2000000, supportsTools: true, supportsVision: true },
      { id: "meta-llama/llama-4-70b", label: "Llama 4 70B (via OR)", contextWindow: 131072, supportsTools: true, supportsVision: false },
      { id: "deepseek/deepseek-v4", label: "DeepSeek V4 (via OR)", contextWindow: 128000, supportsTools: false, supportsVision: false },
    ],
  },
  {
    id: "mistral",
    ...
    authType: "apiKey",
    models: [
      { id: "mistral-large-3", label: "Mistral Large 3", contextWindow: 131072, supportsTools: true, supportsVision: true },
      { id: "mistral-pixtral-2", label: "Pixtral 2", contextWindow: 131072, supportsTools: true, supportsVision: true },
      { id: "codestral-2", label: "Codestral 2", contextWindow: 65536, supportsTools: true, supportsVision: false },
      { id: "mistral-small-3", label: "Mistral Small 3", contextWindow: 32768, supportsTools: true, supportsVision: false },
    ],
  },
  {
    id: "huggingface",
    ...
    authType: "apiKey",
    models: [
      { id: "deepseek-ai/DeepSeek-V4", label: "DeepSeek V4", contextWindow: 131072, supportsTools: false, supportsVision: false },
      { id: "meta-llama/Llama-4-70B-Instruct", label: "Llama 4 70B Instruct", contextWindow: 131072, supportsTools: false, supportsVision: false },
      { id: "Qwen/Qwen-3-72B-Instruct", label: "Qwen 3 72B Instruct", contextWindow: 131072, supportsTools: false, supportsVision: false },
    ],
  },
];
...
export const DEFAULT_MODEL_SETTINGS: ModelSettings = {
  ...
  maxTokens: 4096,
  repeatPenalty: 1.1,
  systemPrompt: "You are a helpful homelab sysadmin assistant. Give concise, command-oriented answers. When suggesting shell commands, put them in fenced ```bash code blocks so the user can run them with one click.",
  quantization: "Q4_K_M",
  numGpu: -1,
  numThreads: 0,
  contextLength: 4096,
...
export function loadTools(): ToolDef[] {
  ...
  try {
    ...
    if (raw) {
      ...
      // Merge: keep saved enabled states but add any new tools
...
export const DEFAULT_SKILLS: SkillDef[] = [
  {
    ...
    icon: "🖥️",
    enabled: true,
    systemPromptAddition: "You are an expert Linux sysadmin. Help with package management, service configuration, user management, and system hardening.",
  },
  {
    id: "docker",
    ...
    icon: "🐳",
    enabled: true,
    systemPromptAddition: "You are a Docker and containerization expert. Help with Dockerfiles, docker-compose, container networking, volumes, and troubleshooting.",
  },
  {
    id: "networking",
    label: "Networking",
    ...
    icon: "🌐",
    enabled: true,
    systemPromptAddition: "You are a networking expert. Help with DNS, iptables/nftables, VPNs (WireGuard/OpenVPN), Nginx/Traefik/Caddy reverse proxy, and network troubleshooting.",
  },
  {
    id: "scripting",
    ...
    icon: "📜",
    enabled: true,
    systemPromptAddition: "You are a scripting and automation expert. Help write bash scripts, Python scripts, cron jobs, systemd units, and CI/CD pipeline configurations.",
  },
  {
    id: "security",
    ...
    icon: "🔒",
    enabled: false,
    systemPromptAddition: "You are a security expert. Help with SSH hardening, firewall configuration, fail2ban, SSL/TLS certificates, and security auditing.",
  },
  {
    id: "monitoring",
    ...
    icon: "📈",
    enabled: false,
    systemPromptAddition: "You are a monitoring expert. Help set up Prometheus, Grafana, log aggregation (Loki, ELK), and alerting systems.",
  },
  {
    id: "database",
    ...
    icon: "🗄️",
    enabled: false,
    systemPromptAddition: "You are a database expert. Help with PostgreSQL, MySQL, Redis, MongoDB administration, query optimization, and backup strategies.",
  },
  {
    id: "code_review",
    label: "Code Review",
    ...
    icon: "🔎",
    enabled: false,
    systemPromptAddition: "You are a code review expert. Analyze code for bugs, security issues, performance problems, and suggest improvements.",
  },
];
...
export const EMBEDDING_MODELS: Record<EmbeddingProviderId, { id: string; label: string; dimensions: number }[]> = {
  openai: [
  ...
  local: [
    { id: "all-MiniLM-L6-v2", label: "all-MiniLM-L6-v2 (local)", dimensions: 384 },
  ],
};
...
export function getActiveProviderAndModel(): { provider: ProviderDef; model: ModelDef; config: ProviderConfig } | null {
...
/** Build the system prompt from base + enabled skills */
...
const DEFAULT_AGENTS: AgentDef[] = [
  {
    ...
    providerId: "ollama",
    modelId: "llama3.3",
    systemPrompt: "You are a helpful homelab sysadmin assistant. Give concise, command-oriented answers. When suggesting shell commands, put them in fenced ```bash code blocks.",
  ...
  },
  {
    ...
    providerId: "ollama",
    modelId: "llama3.3",
    systemPrompt: "You are a Docker and container orchestration expert. Help manage containers, compose files, networking, and troubleshoot container issues.",
  ...
  },
  {
    ...
    systemPrompt: "You are an expert programmer. Help write, review, and debug code. Focus on clean, well-documented solutions.",
